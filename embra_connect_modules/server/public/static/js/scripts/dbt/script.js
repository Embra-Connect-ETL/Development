  ...
  static async h_ADD(USER_INFO) {
    ...
    try {
      ...
      request.onsuccess = function () {
        ...
        Notifications.displayToasterMessage("Configuration has been added!");
      };
  ...
  static async h_UPDATE(UPDATED_PAYLOAD) {
    try {
      ...
      request.onsuccess = function () {
        ...
        Notifications.displayToasterMessage("Configuration has been updated!");
      };
      ...
      request.onerror = function (event) {
        console.log(
          "An [ERROR] occurred when performing an [UPDATE]:",
          event.target.error,
        );
      };
    ...
    try {
      ...
      request.onsuccess = function (event) {
        ...
        if (userInfo) {
          ...
          Notifications.displayToasterMessage("Configuration not found!");
        }
      };
...
class App {
  static async checkAndSetDefaultValues() {
    ...
    try {
      ...
      request.onerror = function (event) {
        console.log(
          "Error retrieving [OBJECT STORE DATA]:",
          event.target.error,
        );
      };
